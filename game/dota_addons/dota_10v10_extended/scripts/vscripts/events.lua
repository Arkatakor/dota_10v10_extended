...
function CMegaDotaGameMode:OnDisconnect(keys)
...
function CMegaDotaGameMode:OnGameRulesStateChange(keys)
	...
	CMegaDotaGameMode:_OnGameRulesStateChange(keys)
...
function CMegaDotaGameMode:OnNPCSpawned(keys)
	...
	-- This internal handling is used to set up main barebones functions
	CMegaDotaGameMode:_OnNPCSpawned(keys)
...
-- operations here
function CMegaDotaGameMode:OnEntityHurt(keys)
...
function CMegaDotaGameMode:OnItemPickedUp(keys)
...
-- state as necessary
function CMegaDotaGameMode:OnPlayerReconnect(keys)
	PrintTable(keys)
...
function CMegaDotaGameMode:OnAbilityUsed(keys)
...
function CMegaDotaGameMode:OnNonPlayerUsedAbility(keys)
...
function CMegaDotaGameMode:OnPlayerChangedName(keys)
...
function CMegaDotaGameMode:OnPlayerLearnedAbility( keys)
...
function CMegaDotaGameMode:OnAbilityChannelFinished(keys)
...
-- A player leveled up
function CMegaDotaGameMode:OnPlayerLevelUp(keys)
...
function CMegaDotaGameMode:OnLastHit(keys)
...
function CMegaDotaGameMode:OnTreeCut(keys)
...
function CMegaDotaGameMode:OnRuneActivated (keys)
...
function CMegaDotaGameMode:OnPlayerTakeTowerDamage(keys)
...
function CMegaDotaGameMode:OnPlayerPickHero(keys)
...
function CMegaDotaGameMode:OnTeamKillCredit(keys)
...
-- An entity died
function CMegaDotaGameMode:OnEntityKilled( keys )
	DebugPrint( '[BAREBONES] OnEntityKilled Called' )
	DebugPrintTable( keys )

	CMegaDotaGameMode:_OnEntityKilled( keys )
...
function CMegaDotaGameMode:PlayerConnect(keys)
	DebugPrint('[BAREBONES] PlayerConnect')
	DebugPrintTable(keys)
end

-- This function is called once when the player fully connects and becomes "Ready" during Loading
function CMegaDotaGameMode:OnConnectFull(keys)
	DebugPrint('[BAREBONES] OnConnectFull')
	DebugPrintTable(keys)

	CMegaDotaGameMode:_OnConnectFull(keys)
...
function CMegaDotaGameMode:OnIllusionsCreated(keys)
...
function CMegaDotaGameMode:OnItemCombined(keys)
...
function CMegaDotaGameMode:OnAbilityCastBegins(keys)
...
function CMegaDotaGameMode:OnTowerKill(keys)
...
function CMegaDotaGameMode:OnPlayerSelectedCustomTeam(keys)
...
function CMegaDotaGameMode:OnNPCGoalReached(keys)
